...
- 修复所有TypeScript编译错误
- 前端客户表单优化（2026-01-07）：
  - 办税人员功能重构：支持多人添加、填写详细信息、查询已有人员
  - 渝快办密码改为明文显示
  - 调整字段分组：信用等级移到税务信息，经营范围移到基础信息注册资本后
  - 修复提交问题：防止重复提交，修复模态框无法关闭的问题
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v0.5.0 | 2026-01-05 ~ 2026-01-07 | PersonType重构与前端开发完成 |
